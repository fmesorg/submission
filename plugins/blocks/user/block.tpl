		...
		{else}
			<form method="post" action="{$userBlockLoginUrl}">
				<table width="100%">
					...
					<tr>
						<td colspan="3"><input type="checkbox" id="remember" name="remember" value="1" /> <label class="remember1" for="remember">{translate key="plugins.block.user.rememberMe"}</label><label class="remember">|&nbsp;<a href="{$baseUrl}/index.php/ijme/user/register">Register</a></label><label class="remember">|&nbsp;<a href="{$baseUrl}/index.php/ijme/login/lostPassword">Forgot password</a></label></td>
					</tr>
					<tr>
