...
class TemplateManager extends PKPTemplateManager {
	...
	function smartyPageLinks($params, &$smarty) {
		...
		/*FIXME: $numPageLinks somehow gets the value 0 from $smarty->get_template_vars('numPageLinks')*/
		$numPageLinks = 10;
		...
		if ($page>1) {
			...
			global $value;
			$params[$paramName] = 1;
			//$value .= '<a title="First Page" class="nav-pg-link" href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>&lt;&lt;</a>&nbsp;';
			$value .= '<a class="nav-pg-link" href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>First</a>&nbsp;';
			$params[$paramName] = $page - 1;
			//$value .= '<a title="Previous" class="nav-pg-link" href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>&lt;</a>&nbsp;';
			$value .= '<a class="nav-pg-link" href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>Previous</a>&nbsp;';
		}
		...
		for ($i=$pageBase; $i<min($pageBase+$numPageLinks, $pageCount+1); $i++) {
			global $value;
			if ($i == $page) {
				$value .= "<strong class='nav-pg-link-current'>$i</strong>&nbsp;";
			} else {
				$params[$paramName] = $i;
				$value .= '<a class="nav-pg-link" href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>' . $i . '</a>&nbsp;';
			}
		}
		if ($page < $pageCount) {
			$params[$paramName] = $page + 1;
			//$value .= '<a class="nav-pg-link"  href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>&gt;</a>&nbsp;';
			$value .= '<a class="nav-pg-link" href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>Next</a>&nbsp;';
			$params[$paramName] = $pageCount;
			//$value .= '<a class="nav-pg-link" href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>&gt;&gt;</a>&nbsp;';
			$value .= '<a class="nav-pg-link" href="' . Request::url(null, null, null, Request::getRequestedArgs(), $params, $anchor, true) . '"' . $allExtra . '>Last</a>&nbsp;';
		}
