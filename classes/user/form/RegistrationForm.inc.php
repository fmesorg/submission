	...
	function RegistrationForm() {
		...
		if ($this->implicitAuth) {
			...
			if ($this->existingUser) {
				...
				//$this->addCheck(new FormValidatorLocale($this, 'interestsTextOnly', 'required', 'user.profile.form.interestsRequired'));
				$this->addCheck(new FormValidatorLocale($this, 'affiliation', 'required', 'user.profile.form.affiliation'));
