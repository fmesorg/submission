...
class PKPTemplateManager extends Smarty {
	...
	function PKPTemplateManager($request = null) {
		...
		//strip last url param submissions from base url
		//so http://localhost/ijme/submissions becomes http://localhost/ijme
		$this->assign('wp_url', str_replace( '/'.Config::getVar('wordpress', 'ojs_base_url'), '', $this->request->getBaseUrl()));
