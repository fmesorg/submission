...
class CommentDAO extends DAO {
	...
	function insertComment(&$comment) {
		...
		$this->sendNotificationEmail($comment->getSubmissionId(),$comment->getId(),substr($comment->getPosterName(), 0, 90), substr($comment->getPosterEmail(), 0, 90), substr($comment->getTitle(), 0, 255), $comment->getBody());
	...
	/********************************************************************************************/
	/*Purpose	: Sending comments email to below email for monitoring.
	/*Inputs	: $pintArticleCode	:: Article code, 
				: $pintCommentsCode	:: Comments Code, 
				: $pStrPostedBy	:: Posted By , 
				: $pStrPostedByEmail :: Posted By email address, 
				: $pStrCommentsTitle :: Posted title, 
				: $pStrCommentsBody	:: Posted comments
	/*returns	: None.
	/*Updated BY: Jaiswar Vipin Kumar R. 
	/********************************************************************************************/
	function sendNotificationEmail($pintArticleCode, $pintCommentsCode, $pStrPostedBy, $pStrPostedByEmail, $pStrCommentsTitle, $pStrCommentsBody){
		$strMailBody	= '<table>
								<tr>
									<td><strong>Article : </strong></td>
									<td><strong><a href="http://ijme.in/index.php/ijme/article/view/'.$pintArticleCode.'/0" target="_blank">'.$pintArticleCode.'</a></td>
								</tr>
								<tr>
									<td><strong>Posted By: </strong></td>
									<td><strong>'.$pStrPostedBy.'</td>
								</tr>
								<tr>
									<td><strong>Posted By Email: </strong></td>
									<td><strong>'.$pStrPostedByEmail.'</td>
								</tr>
								<tr>
									<td colspan="2"><strong>Comments Details</strong></td>
								</tr>
								<tr>
									<td><strong>Title: </strong></td>
									<td><strong>'.$pStrCommentsTitle.'</td>
								</tr>
								<tr>
									<td><strong>Comments: </strong></td>
									<td><strong>'.$pStrCommentsBody.'</td>
								</tr>
								<tr>
									<td colspan="2"><a href="http://ijme.in/index.php/ijme/comment/view/'.$pintArticleCode.'/0/'.$pintCommentsCode.'" target="_blank">Click here to view this comment</a></td>
								</tr>
							</table>';
		
		/* Setting HTML mail, the Content-type header must be set */
		$strHeaders  = 'MIME-Version: 1.0' . "\r\n";
		$strHeaders .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
		$strHeaders .= "From: IJME Editorial<ijme.editorial@gmail.com>\r\n";
		$strHeaders .= "Cc: Shifra<shifra@z-aksys.com>\r\n";
		$strHeaders .= "Cc: Anil<anil@z-aksys.com>\r\n";
		$strHeaders .= "Bcc: Jaiswar Vipin Kumar R<vipin@z-aksys.in>\r\n";
		$strHeaders .= "X-Mailer: PHP/" . phpversion();
		
		mail('ijme.comments@gmail.com','IJME Comments',$strMailBody,$strHeaders);
	}
}
