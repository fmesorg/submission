...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="{$baseUrl}/styles/carousel/flexslider.css" type="text/css" />
...
$.pnotify(notification);
	  ...
	  {/literal}
		...
		<div class="col-md-7 i-header-banner">
		  {*<a href="http://216.12.194.36/~ijmein/index.php/ijme/pages/view/advertise"><img src="{$baseUrl}/images/theme/top_banner.jpg"></a>*}
		  {literal}
