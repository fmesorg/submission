		...
		{*<div class="col-md-4">*}
			...
			{else}
				...
				{if empty($filterInput)}
					<input type="text" name="{$filterName}" id="{$filterName}" size="40" maxlength="255" placeholder="{$filterName}" value="{$filterValue|escape}" placeholder="{$filterName}" class="textField">
				{else}
					{$filterInput}
				{/if}
			{/if}
