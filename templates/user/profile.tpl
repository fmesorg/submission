...
<table class="data" width="100%" id="edit-profile">
...
<tr valign="top">
	...
	<td width="15" class="label">{fieldLabel suppressId="true" name="username" key="user.username"}</td>

	<td width="85%" class="value textField">{$username|escape}</td>
...
<tr valign="top">
	...
	<td class="value"><input type="text" name="initials" id="initials" value="{$initials|escape}" size="5" maxlength="5" class="textField" /></td>
</tr>
<tr>
	<td></td>
    <td>{translate key="user.initialsExample"}</td>
</tr>
...
<tr valign="top">
	...
	<td class="value review-interest">
...
<p class="edit-prof-saveSubButton"><input type="submit" value="{translate key="common.save"}" class="button defaultButton" /> <input type="button" value="{translate key="common.cancel"}" class="button" onclick="document.location.href='{url page="user"}'" /></p>
